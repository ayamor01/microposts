class User < ActiveRecord::Base
    ...
    has_many :favorite_relationships, class_name: "Favorite", foreign_key: "favoriter_id", dependent: :destroy
    
    has_many :favorite_microposts, through: :favorite_relationships, source: :favorited
